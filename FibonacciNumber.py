...
class Solution:
      def findFibonacciNumber(self,number:int)->int:
          if number==0:
              return 0 
          if number==1 or number==2:
              return 1
          return self.helper(number)
      def helper(self,number:int)->int:
          if number==0:
              return 0 
          if number==1 or number==2:
              return 1
...
class TestApp:
      def testCaseOne(self):
          assert Solution().findFibonacciNumber(5)==5
      def testCaseTwo(self):
          assert Solution().findFibonacciNumber(3)==2
      def testCaseThree(self):
          assert Solution().findFibonacciNumber(6)==8